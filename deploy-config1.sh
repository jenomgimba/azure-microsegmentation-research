...
# Azure Zero Trust Segmentation Research - Config 1 NSG Deployment
# This script deploys Config 1: NSG subnet-level segmentation

set -e

echo "=================================================="
echo "Azure Zero Trust Segmentation Research"
echo "Config 1: NSG Subnet Segmentation Deployment"
echo "=================================================="
echo ""
...
# Confirm deployment
read -p "Deploy CONFIG 1 (NSG) environment? (y/n): " -n 1 -r
echo ""
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
...
echo ""
echo "=================================================="
echo "Deploying Config 1: NSG Segmentation"
echo "=================================================="
echo ""
...
echo ""
echo "Saving outputs..."
terraform output > ../config1-outputs.txt
